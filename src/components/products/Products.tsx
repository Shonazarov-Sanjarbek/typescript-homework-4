    ...
    return (
      <div className="flex items-center justify-center space-x-2 mt-4">
        ...
        <button
          ...
          className={`px-3 py-1 rounded-md bg-blue-400 text-black ${
            currentPage === totalPages
        ...
        <div className="p-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                {data?.map((product: Product) => (
                    <div
                        key={product.id}
                        className="rounded-lg shadow-lg overflow-hidden transform transition duration-300 hover:scale-105 hover:shadow-2xl"
                    >
                        <div className="p-6">
                            <Link
