            ...
            <footer className="py-8">
                <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div className="flex flex-col">
                        <h2 className="text-2xl font-bold text-yellow-600 mb-4">Main</h2>
                    ...
                    <div>
                        <h3 className="text-xl font-semibold text-yellow-600 mb-4">Quick Links</h3>
                    ...
                    <div>
                        <h3 className="text-xl font-semibold text-yellow-600 mb-4">Resources</h3>
                        <ul className="space-y-2">
